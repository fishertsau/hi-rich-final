...
@section('content')
    <div id="container">
        <div id="site"><a href="/admin">首頁</a>>安裝實例管理</div>
        <img src="/system/images/icon_arrowdown.gif" width="15" height="19"/>
        <a href="/admin/samples/create"><img src="/system/images/new.gif" width="75" height="19"/></a><br/>
            ...
            @foreach ($samples as $sample)
                <tr>
                    ...
                    <td align="left" bgcolor="#ECECEC" class="border-sdown"><a
                                href="/admin/samples/{{$sample->id}}/edit"> {{$sample->title}}</a>
                    </td>
                    <td align="center" bgcolor="#ECECEC" class="border-sdown">
                        {{$sample->created_at}}</td>
                    ...
                    <td align="center" bgcolor="#ECECEC" class="border-sdown">
                        <a href="/admin/samples/{{$sample->id}}/edit"><img
                                    src="/system/images/bt-revise.gif" width="23" height="23"/></a>
                    </td>
                    <td align="center" bgcolor="#ECECEC" class="border-sdown">
                        <a href="/admin/samples/{{$sample->id}}/copy"><img
        ...
        <table width="99%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td align="right">
                    {{ $samples->links('vendor.pagination.system') }}
                </td>
            </tr>
        </table>
        <br/>
...
@section('pageJS')
    <script type="text/javascript" src="{{ asset('/js/system/sample/sampleIndex.js') }}"></script>
@endsection